...
export default function Index({ projects = [], cathegories = [] }) {
    ...
    const handleSubmit = async (e) => {
        ...
        // Ajouter les images - Version simplifiée
    ...
    const handleEdit = (project) => {
        router.visit(route('admin.projects.edit', project.id));
    };
                            ...
                            <div className="px-6 py-6 max-h-[calc(100vh-200px)] overflow-y-auto">
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                        ...
                                        <div className="space-y-5">
                                            ...
                                            <div>
                                                ...
                                                {errors.cathegorie && (
                                                    <p className="text-red-500 text-xs mt-1">{errors.cathegorie}</p>
                                                )}
                                            </div>
                                            ...
                                            <div className="space-y-3">
                                                <label className="flex items-center gap-3 cursor-pointer group">
                                                    <input
                                                        ...
                                                        className="w-4 h-4 rounded border-base text-primary-500 focus:ring-primary-500 focus:ring-offset-0"
                                                    />
                                                    <span className="text-sm text-base-primary group-hover:text-primary-500 transition-colors flex items-center gap-2">
                                                        <Star size={16} />
                                                        Featured Project
                                                    </span>
                                                </label>
                                    ...
                                    <div className="border-t border-base pt-5">
                                                ...
                                                <div key={index} className="flex gap-2">
                                                    <div className="relative flex-1">
                                                        ...
                                                        <input
                                                            ...
                                                            placeholder={`Tool ${index + 1} (e.g., Laravel, React, Tailwind)`}
                                                            className="input pl-10"
                                                        />
                                                    </div>
                                        ...
                                        {data.outils.filter(t => t && t.trim() !== '').length < 3 && (
                                            <p className="text-yellow-500 text-xs mt-2 flex items-center gap-1">
                                                <AlertCircle size={12} /> 
                                                Please add at least {3 - data.outils.filter(t => t && t.trim() !== '').length} more tool(s)
                                            </p>
                                        )}
                                    </div>
                                    ...
                                    <div className="border-t border-base pt-5">
                                                ...
                                                {imagePreviews.map((preview, index) => (
                                                    <div key={index} className="relative group">
                                                        <img
                                                            src={preview}
                                                            alt={`Preview ${index + 1}`}
                                                            className="w-full h-32 object-cover rounded-xl border border-base"
                                                        />
                                                        <button
                                                            type="button"
                                        ...
                                        <div className="relative">
                                            ...
                                            <label 
                                                ...
                                                className="input flex items-center justify-center gap-2 cursor-pointer hover:border-primary-500 transition-colors min-h-[120px]"
                                            >
                                                <Upload className="text-primary-500" size={24} />
                                                <div className="text-center">
                                                    <p className="text-base-primary font-medium">Click to upload images</p>
                                                    <p className="text-base-muted text-sm">PNG, JPG, GIF, WebP up to 2MB each</p>
                                                    <p className="text-primary-500 text-xs mt-1 font-semibold">
                                                        {data.images.length} image(s) selected (max 10)
                                                    </p>
                                                </div>
                                            </label>
                                        </div>
                                        ...
                                        {data.images.length > 0 && data.images.length < 4 && (
                                            <p className="text-yellow-500 text-xs mt-2 flex items-center gap-1">
                                                <AlertCircle size={12} /> 
                                                {4 - data.images.length} more image(s) needed (minimum 4 required)
                                            </p>
                                        )}
                                        ...
                                        {data.images.length >= 4 && (
                                            <p className="text-green-500 text-xs mt-2 flex items-center gap-1">
                                                <CheckCircle size={12} /> 
                                                Great! You have {data.images.length} images. You can add up to 10.
                                            </p>
                                        )}

...
export default function BlogEdit({ post: article }) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        image: null,
        cathegorie: article.cathegorie ? article.cathegorie.join(', ') : '',
    ...
    const handleSubmit = (e) => {
        e.preventDefault()
        // En Inertia, les uploads de fichiers avec PUT nécessitent une ruse en utilisant POST avec _method: 'PUT'
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-base-muted">Mettez à jour le contenu de votre post</p>
                        </div>
                    </div>
                    <button 

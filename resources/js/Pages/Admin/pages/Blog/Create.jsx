...
import {
    ...
    Terminal, Crosshair, Sparkles, BookOpen, Eye, X
} from 'lucide-react'
...
export default function BlogCreate() {
    const { data, setData, post, processing, errors } = useForm({
        ...
        contenue: '',
        image: null,
        cathegorie: 'Design, Branding, Typographie',
        temps_lecture: 5,
        is_published: false,
    })
    ...
    return (
        <AdminLayout title="Rédiger un Article">
            <div className="space-y-8 w-full">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-gray-800">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <div className="flex items-center gap-2 font-mono text-[10px] uppercase tracking-widest text-primary-500 font-bold mb-1">
                                <Terminal size={12} />
                                <span>ÉDITEUR MARKDOWN & CONTENU</span>
                            </div>
                            <h1 className="text-2xl font-display font-bold uppercase tracking-tight text-white">
                                RÉDIGER UN <span className="text-primary-500">NOUVEL ARTICLE</span>
                            </h1>
                        </div>
                    </div>
                    ...
                    >
                        <Save size={14} />
                        {processing ? 'ENREGISTREMENT...' : 'PUBLIER / ENREGISTRER'}
                    </button>
                </div>
                    ...
                    <div className="border border-gray-800 bg-[#0E0E0E] p-6 space-y-5">
                        <div>
                            ...
                            <input
                                ...
                                placeholder="Ex: Pourquoi la typographie suisse domine encore le design moderne"
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="Ex: Analyse des grilles asymétriques et contrastes"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="Branding, Typographie, Minimalisme"
                                    className="w-full bg-[#141414] border border-gray-800 text-white px-3 py-2 text-xs font-mono focus:border-primary-500 focus:outline-none"
                                />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                placeholder="Court extrait pour attirer l'attention des lecteurs..."
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 items-start">
                                <div className="border-2 border-dashed border-gray-800 p-6 text-center bg-[#141414] flex-1 w-full">
                                    <input
                                        ...
                                        id="blog-cover-input"
                                    />
                                    <label htmlFor="blog-cover-input" className="cursor-pointer flex flex-col items-center gap-1">
                                        <Upload size={20} className="text-gray-500" />
                                        <span className="text-xs font-mono text-primary-500 uppercase font-bold">Sélectionner une photo de couverture</span>
                        ...
                        <div>
                            ...
                            {tab === 'write' ? (
                                <textarea
                                    ...
                                    placeholder="# Titre de section&#10;&#10;Votre texte ici avec support **gras**, *italique*, [liens](url), listes, et blocs de code..."
                                ...
                                <div className="p-6 bg-[#141414] border border-gray-800 min-h-[300px] text-xs font-mono text-gray-300 whitespace-pre-wrap leading-relaxed">
                                    {data.contenue || 'Aucun contenu rédigé pour le moment.'}
                                </div>
                            )}
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-gray-800 font-mono text-xs">
                            ...
                            <div className="flex items-center">
                                <label className="flex items-center gap-2 cursor-pointer">
                                    ...
                                    />
                                    <span className="text-white font-bold">Publier immédiatement cet article</span>
                                </label>
                            </div>
                        </div>
